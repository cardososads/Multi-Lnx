...
<p style="color: #1A1A1A; font-family: Roboto, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 24px; margin: 0; padding: 0 0 28px; text-align: left; word-wrap: normal;">
	<?php printf( __( "Hi %s", 'defender-security' ), $name ) ?>,
</p>
<p style="font-family: inherit; font-size: 16px; margin: 0 0 30px">
    <?php printf( __( 'An administrator from <strong>%s</strong> has subscribed <strong>%s</strong> to <strong>%s</strong>. To confirm your subscription, click Confirm Subscription below.', 'defender-security' ),
...
<p style="margin: 0;padding: 0;text-align: center">
    <a class="button"
       ...
       href="<?php echo $url ?>"><?php _e( 'Confirm Subscription', 'defender-security' ) ?></a>
</p>
