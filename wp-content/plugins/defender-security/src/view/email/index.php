                                                    ...
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float:none;display:inline-table;">
                                                        <tr class="hidden-img">
                                                            ...
                                                            <td style="vertical-align:middle;">
                                                                <span style="color:#333333;font-size:13px;font-weight:700;font-family:Roboto, Arial, sans-serif;line-height:25px;text-decoration:none;"> <?php _e( 'Follow us', 'defender-security' ); ?> </span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <td align="center" style="font-size:0;padding:0 0 15px;word-break:break-word;">
                                                ...
                                                if ( ! empty( $unsubscribe_link ) ) { ?>
                                                    <div style="font-family:Roboto, Arial, sans-serif;font-size:10px;letter-spacing:-.25px;line-height:30px;text-align:center;color:#505050;">
                                                        <a href="<?php echo esc_url( $unsubscribe_link ); ?>" style="color: #000!important;text-decoration-line:underline!important;font-weight: 400!important;"><?php _e( 'Unsubscribe', 'defender-security' ); ?></a>
                                                    </div>
                                                <?php } ?>
                                                <!-- End Unsubscribe -->
                                            </td>
