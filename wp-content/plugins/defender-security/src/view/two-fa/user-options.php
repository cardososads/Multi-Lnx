...
<h2 class="defender-header"><?php _e( 'Security', 'defender-security' ); ?></h2>
...
<div class="defender-biometric-wrap" <?php echo true !== $webauthn_enabled ? 'style="display:none;"' : ''; ?>>
	...
	<div class="register-authenticator-box" style="display:none;">
		...
		<div class="desc">
			<?php esc_html_e( 'Register a new authenticator for the current user account. You can register multiple authenticators for an account.', 'defender-security' ); ?>
		</div>
		...
		<button type="button" id="wpdef-register-authenticator-btn" class="button"><?php esc_html_e( 'Start Registration', 'defender-security' ); ?></button>
		<button type="button" id="wpdef-register-authenticator-close-btn" class="button"><?php esc_html_e( 'Cancel', 'defender-security' ); ?></button>
