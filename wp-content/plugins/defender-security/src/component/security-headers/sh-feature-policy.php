...
class Sh_Feature_Policy extends Security_Header {
	...
	public function get_misc_data() {
		...
		return array(
			'intro_text' => esc_html__( 'The Permissions-Policy response header provides control over what browser features can be used when web pages are embedded in iframes.', 'defender-security' ),
	...
	public function get_title() {
		return __( 'Permissions-Policy', 'defender-security' );
	}
}
