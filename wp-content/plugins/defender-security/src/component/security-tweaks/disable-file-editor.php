...
class Disable_File_Editor extends Component {
	...
	public function to_array() {
		return array(
			'slug'             => $this->slug,
			'title'            => __( 'Disable the file editor', 'defender-security' ),
			'errorReason'      => __( 'The file editor is currently enabled.', 'defender-security' ),
			'successReason'    => __( 'You\'ve disabled the file editor, winning.', 'defender-security' ),
			'misc'             => array(),
			'bulk_description' => __( 'The file editor is currently active, this means anyone with access to your login information can further edit your plugin and theme files and inject malicious code. We will disable file editor for you.', 'defender-security' ),
			'bulk_title'       => __( 'File Editor', 'defender-security' ),
		);
	}
}
