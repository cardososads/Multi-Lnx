...
class Recaptcha extends Component {
	...
	public function error_message(): string {
		...
		/* translators: %s: Error message. */
			__( '<strong>Error:</strong> %s', 'defender-security' ),
	...
	public static function get_forms(): array {
		return [
			self::DEFAULT_LOGIN_FORM => __( 'Login', 'defender-security' ),
			self::DEFAULT_REGISTER_FORM => __( 'Register', 'defender-security' ),
			self::DEFAULT_LOST_PASSWORD_FORM => __( 'Lost Password', 'defender-security' ),
			self::DEFAULT_COMMENT_FORM => __( 'Comments', 'defender-security' ),
		];
	}
}
